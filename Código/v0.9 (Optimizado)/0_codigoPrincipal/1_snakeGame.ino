...
byte xs[100];//Matriz que contiene todos los segmentos de la serpiente, su máxima longitud es el tamaño de la matriz
byte ys[100];//xs es su posición en x, ys es su posición en y
